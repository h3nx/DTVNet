...
from flow.ARFlow.utils.flow_utils import evaluate_flow
from flow.ARFlow.utils.misc_utils import AverageMeter
...
class TrainFramework(BaseTrainer):
    ...
    def _validate_with_gt(self):
        ...
        if self.i_iter > self.cfg.save_iter:
            self.save_model(all_error_avgs[0] + all_error_avgs[1], name='Sky')
